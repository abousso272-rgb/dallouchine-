    ...
    <div className="space-y-6">
          ...
          {(['7d', '30d', '3m', '12m'] as const).map(tf => (
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                timeframe === tf
                  ? 'bg-[#2A6DFF] text-white shadow-md shadow-blue-500/20'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-3xl bg-[#0a1945] border border-blue-900/40 shadow-md flex flex-col justify-between hover:border-blue-500/40 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <div className="p-2.5 rounded-2xl bg-blue-500/10 text-[#2A6DFF] border border-blue-500/20">
            ...
            {todoTasks.map(task => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-2 border-t border-white/5 text-[11px]">
                  ...
                  <span className="text-[#2A6DFF] font-bold flex items-center gap-1 group-hover:translate-x-1 transition-transform">
                    <span>Traiter</span>
      ...
      <div className="bg-[#0a1945] rounded-3xl border border-blue-900/50 p-5 shadow-lg space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-blue-900/40">
          <div>
            <h2 className="text-sm font-black text-white uppercase tracking-wider flex items-center gap-2">
              <BarChart3 className="w-4 h-4 text-[#2A6DFF]" />
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="flex items-center gap-2 text-xs">
              <span className="w-3 h-3 rounded-full bg-[#2A6DFF]" />
              ...
              return (
                <div key={idx} className="flex flex-col items-center gap-2 h-full justify-end group relative">
                  ...
                  <div className="w-full max-w-[80px] flex items-end justify-center gap-2 h-full">
                    <div
                      className="w-1/2 rounded-t-xl bg-[#2A6DFF] transition-all duration-300 group-hover:brightness-125 shadow-sm shadow-blue-500/20 relative"
      ...
      <div className="bg-[#0a1945] rounded-3xl border border-blue-900/50 p-5 shadow-lg space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-blue-900/40">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1 bg-[#050e26] p-1 rounded-xl border border-blue-900/50 text-[11px]">
              <button
                ...
                className={`px-2.5 py-1 rounded-lg font-bold transition-all ${
                  orderStatusFilter === 'all' ? 'bg-[#2A6DFF] text-white' : 'text-slate-400 hover:text-white'
                }`}
              >
                Toutes
              </button>
            ...
            <button
              onClick={() => navigate('/admin/orders')}
              className="text-xs font-bold text-white bg-[#2A6DFF] hover:bg-blue-600 px-3.5 py-2 rounded-xl flex items-center gap-1.5 transition-all shadow-md shadow-blue-500/20 ml-auto sm:ml-2"
            >
                    ...
                    <td className="py-3 px-3 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        ...
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-[#2A6DFF]/10 hover:bg-[#2A6DFF] text-[#2A6DFF] hover:text-white border border-[#2A6DFF]/20 transition-all"
            ...
            <div className="flex items-center justify-between pt-3 border-t border-blue-900/40">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-[#2A6DFF] hover:bg-blue-600 text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-blue-500/20"
                >
